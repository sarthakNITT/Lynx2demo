...
export default function HomeScreen({ navigation }) {
  const [activeTab, setActiveTab] = useState(
    USER_STORE.getUserType !== "CLUB" ? "Class" : "Campus"
  );
  ...
  return (
    <SafeAreaView>
        ...
        <View style={styles.tabContainer}>
          {USER_STORE.getUserType !== "CLUB" && (
            <View style={styles.tabWithIndicator}>
              ...
              >
                <Text style={styles.tabText}>Class Activity</Text>
              </TouchableOpacity>
              <View
                style={[
                  styles.toggleContainer,
                  activeTab === "Class" ? styles.blackBackground : styles.whiteBackground,
                ]}
              />
            </View>
          )}
          <View style={styles.tabWithIndicator}>
            <TouchableOpacity
              ...
              style={[
                styles.tabButton,
                activeTab === "Campus" && styles.activeTabButton,
              ]}
            >
              <Text style={styles.tabText}>Campus Activity</Text>
            </TouchableOpacity>
            <View
              style={[
                styles.toggleContainer,
                activeTab === "Campus" ? styles.blackBackground : styles.whiteBackground,
              ]}
            />
          </View>
        </View>
      ...
      <View style={styles.contentContainer}>
        {activeTab === "Class" ? <ClassActivityScreen /> : <CampusActivityScreen />}
      </View>
    </SafeAreaView>
  );
}
